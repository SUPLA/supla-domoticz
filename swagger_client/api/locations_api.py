...
class LocationsApi(object):
    ...
    def get_location(self, id, **kwargs):  # noqa: E501
        """Get location by ID  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_location(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_location_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_location_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def get_location_with_http_info(self, id, **kwargs):  # noqa: E501
        """Get location by ID  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_location_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_location`")  # noqa: E501
    ...
    def update_location(self, body, id, **kwargs):  # noqa: E501
        """Update location  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_location(body, id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param LocationUpdateRequest body: (required)
        :param int id: (required)
        :param list[str] include: Specify what extra fields to include in the response.
        :return: Location
                 If the method is called asynchronously,
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_location_with_http_info(body, id, **kwargs)  # noqa: E501
        else:
            (data) = self.update_location_with_http_info(body, id, **kwargs)  # noqa: E501
            return data

    def update_location_with_http_info(self, body, id, **kwargs):  # noqa: E501
        """Update location  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_location_with_http_info(body, id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['body', 'id', 'include']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
